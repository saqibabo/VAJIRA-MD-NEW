...
global.owner = process.env.OWNER_NUMBER  || '+923432094503' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process|VAJIRA-MD=CVVDGRKK#A5MkM3InZQC9C7teOV21kZW0Ok7lHmII_5e_ZlHMUXE| ' ' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "+923432094503,+923432094503" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'saqibaba' ,
